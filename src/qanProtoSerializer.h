...
class ProtoSerializer : public QObject,
                        public gtpo::Serializer< qan::GraphConfig >
{
...
public:
    ...
    //@{
public:
    using   NodeOutFunctor = gtpo::ProtoSerializer< qan::GraphConfig >::NodeOutFunctor;
    ...
    using   EdgeOutFunctor = gtpo::ProtoSerializer< qan::GraphConfig >::EdgeOutFunctor;
    ...
    using   GroupOutFunctor = gtpo::ProtoSerializer< qan::GraphConfig >::GroupOutFunctor;
...
public:
    using IdObjectMap   = gtpo::ProtoSerializer< qan::GraphConfig >::IdObjectMap;
...
protected:
    gtpo::ProtoSerializer< qan::GraphConfig >    _gtpoSerializer;

public:
    //! Shortcut to gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoEdgeOut().
    static  auto    serializeGTpoEdgeOut( const WeakEdge& weakEdge, gtpo::pb::Edge& pbEdge, const ObjectIdMap& objectIdMap ) -> void { gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoEdgeOut( weakEdge, pbEdge, objectIdMap ); }
    //! Shortcut to gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoEdgeIn().
    static  auto    serializeGTpoEdgeIn(  const gtpo::pb::Edge& pbEdge, WeakEdge& weakEdge, IdObjectMap& idObjectMap ) -> void { gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoEdgeIn( pbEdge, weakEdge, idObjectMap ); }

public:
    //! Shortcut to gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoGroupOut().
    static  auto    serializeGTpoGroupOut( const WeakGroup& weakGroup, gtpo::pb::Group& pbGroup, const ObjectIdMap& objectIdMap ) -> void { gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoGroupOut( weakGroup, pbGroup, objectIdMap ); }
    //! Shortcut to gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoGroupIn().
    static  auto    serializeGTpoGroupIn(  const gtpo::pb::Group& pbGroup, WeakGroup& weakGroup, IdObjectMap& idObjectMap ) -> void { gtpo::ProtoSerializer< qan::GraphConfig >::serializeGTpoGroupIn( pbGroup, weakGroup, idObjectMap ); }
    //@}
    //-------------------------------------------------------------------------
